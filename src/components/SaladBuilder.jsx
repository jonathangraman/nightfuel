  ...
  return (
    <div className="salad-builder">
      <div className="salad-header">
        ...
        <p className="section-sub">{inSeasonCount} toppings in season right now for {MONTH_NAME} · pick a base, toppings, and dressing</p>
      </div>
        ...
        <div className="salad-steps">
          ...
          <div className="builder-step">
            <div className="step-header">
              ...
              <div>
                ...
                <div className="step-sub">{toppings.length}/6 selected · green border = in season</div>
              </div>
            </div>
          ...
          <div className="builder-step">
            <div className="step-header">
              ...
              <div><div className="step-title">Pick a Dressing</div><div className="step-sub">Green border = in season</div></div>
            </div>
            <div className="dressing-grid">
              {SALAD_DRESSINGS.map(d => (
                <button key={d.id} className={`dressing-card ${dressing?.id === d.id ? "selected" : ""} ${d.season?.includes(MONTH) ? "in-season" : ""}`} onClick={() => setDressing(dressing?.id === d.id ? null : d)}>
